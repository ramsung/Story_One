...
public class WriterBulletSpan extends BulletSpan {
    ...
    public WriterBulletSpan(int bulletColor, int bulletRadius, int bulletGapWidth) {
    ...
    public WriterBulletSpan(Parcel src) {
        super(src);
