...
public class WriterQuoteSpan extends QuoteSpan {
    ...
    public WriterQuoteSpan(int quoteColor, int quoteStripeWidth, int quoteGapWidth) {
    ...
    public WriterQuoteSpan(Parcel src) {
        super(src);
